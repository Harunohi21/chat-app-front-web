class ApplicationController < ActionController::Base
  ...
  def retrieve_direct_thread
    ...
    @t_direct_react_msgids = response["t_direct_react_msgids"] || []
    @t_direct_msg_emojiscounts = response["t_direct_msg_emojiscounts"] || []
    @direct_react_usernames = response["direct_react_usernames"] || []
  end
  ...
  def retrieve_group_thread
    ...
    @t_group_react_msgids = response["retrieveGroupThread"]["t_group_react_msgids"]
    @group_emoji_counts = response["retrieveGroupThread"]["group_emoji_counts"]
    @group_react_usernames = response["retrieveGroupThread"]["group_react_usernames"]
  end
